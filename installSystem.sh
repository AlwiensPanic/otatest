...
# Re execute the app
adb shell "am start -n \"io.github.otaupdater.otaupdater/com.himax.otaupdater.activity.MainActivity\" -a android.intent.action.MAIN -c android.intent.category.LAUNCHER"
