package com.himax.otaupdater.activity;
...
import static com.himax.otaupdater.util.Config.DownloadFileName;
import static com.himax.otaupdater.util.Config.Downloader;
import static com.himax.otaupdater.util.Config.PermissionRequest;
import static com.himax.otaupdater.util.Config.PutStringPreferences;
import static com.himax.otaupdater.util.Config.Showlog;
import static com.himax.otaupdater.util.Config.UpdaterUri;
import static com.himax.otaupdater.util.Config.isOnline;
import static com.himax.otaupdater.util.Config.uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isOnline(this)) {
            if(!isVersionValid(UpdaterUri())){
                Url="https://raw.githubusercontent.com/panicDev/otatest/master/Updater.xml";
            }else {
                Url=UpdaterUri();
            }
